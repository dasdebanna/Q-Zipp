...
#for contacting give the email id and password working on it
EMAIL_BACKEND ='django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'f20221112@pilani.bits-pilani.ac.in'
EMAIL_RECEIVING_USER = ['f20221112@pilani.bits-pilani.ac.in']
